...
class InstructBlipForConditionalGeneration(InstructBlipPreTrainedModel):
    ...
    def generate(
        ...
        set_min_padding_size: bool = True ,
        sp_token: Optional[int] = 32100, # flant5-- 32100; vicuna-- 32001
        generate_conditions: Optional[bool] = False,
        return_logits: Optional[bool] = False,
        condition_from: Optional[int] = -1, 
        **generate_kwargs,
    ) -> torch.LongTensor:
        """
        ...
        if generate_conditions:
            ...
            if condition_from == -1:
                global_conditions = outputs.encoder_last_hidden_state[eos_token_index]
            else:
                global_conditions = outputs.encoder_hidden_states[condition_from][eos_token_index]
