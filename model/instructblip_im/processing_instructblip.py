...
class InstructBlipProcessor(ProcessorMixin):
    r"""
    + This image processor accept output representations from the previous demos. 
    + The output representations are attended to the original encoded visual features. 
    ...
    def __call__(
        self,
        icl_feedbacks=None, # icl feedback
        images=None,
